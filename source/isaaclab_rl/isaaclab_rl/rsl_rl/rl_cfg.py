...
class RslRlPpoActorCriticCfg:
    ...
    aux_obstacle_hidden_dims: tuple[int, ...] = (128, 64)
    """Ignored unless ``class_name`` is :class:`~isaaclab_rl.rsl_rl.aux_obstacle_actor_critic.ActorCriticAuxObstacleDistance`."""
...
class RslRlPpoAlgorithmCfg:
    ...
    """Coefficient for auxiliary MSE on normalized nearest obstacle distance (``PPOAuxObstacleDistance`` only)."""
