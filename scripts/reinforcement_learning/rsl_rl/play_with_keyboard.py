...
"""Script to play a checkpoint of an RL agent from RSL-RL with keyboard input control."""
...
parser = argparse.ArgumentParser(description="Play an RL agent with RSL-RL and keyboard control.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    """Play with RSL-RL agent with keyboard input control."""
    # Flag to control simulation loop
    should_stop = False
