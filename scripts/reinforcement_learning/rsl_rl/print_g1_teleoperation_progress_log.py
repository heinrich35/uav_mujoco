...
#
# Training progress analysis for G1 Teleoperation.
# Same reward structure as standing hand position V2; obs includes teleop target (106 dims).
#
# Usage:
#   python scripts/reinforcement_learning/rsl_rl/print_g1_teleoperation_progress_log.py <log_dir>
#
...
# Same categories as g1_standing_hand_position_v2 (teleoperation uses same rewards)
...
def generate_visual_analysis(log_dir: str, output_name: str = "training_progress_analysis.png") -> str | None:
    ...
    fig.suptitle("Training progress — g1_teleoperation (from training_progress_log.txt)", fontsize=12)
    ax = axes[0, 0]
...
def main():
    parser = argparse.ArgumentParser(
        description="Print training_progress_log.txt for g1_teleoperation and generate visual analysis."
    )
    parser.add_argument("log_dir", type=str, help="Run directory, e.g. logs/rsl_rl/g1_teleoperation/YYYY-MM-DD_HH-MM-SS")
